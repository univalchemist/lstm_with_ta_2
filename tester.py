...
# df = pd.read_csv('data/EURUSDhours.csv', index_col='Gmt time')
...
trace2 = go.Ohlc(x=resampled.index, open=resampled.Open, high=resampled.High, low=resampled.Low, close=resampled.Close, name='Data Resampling')
